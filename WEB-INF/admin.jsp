...
<body>
    ...
    <section id='entete'>
    	<jsp:include page='admin/entete_des_pages.jsp' />	
    </section>  
       	...
       	<table id='mainmenu'>
        	<tr>
                ...
                <td  id='publiCell' rowspan='3'>
                    ...
                    <p id='c2' class='cc1'>
                    	<u><b>Gestion des programmes</b></u></br>
                    ...
                    <p id='c3' class='cc1'>
                    	<u><b>Gestion des actions</b></u></br>
                    ...
                    <p id='c4' class='cc1'>
                    	<u><b>Gestion des projets</b></u></br>
	...
	<!-- Inclusion de footer -->
	<section id='pieds'>
		<jsp:include page='admin/pieds_des_pages.jsp'/>
	</section>
    
    <script type='text/javascript' src='./jscript/design.js'></script>
    <script>
    	$(".optionBloquee").on('click',function(e){
    		e.preventDefault();
    	});
    </script>
</body>
